(function () {
  ...
  GameView.prototype.start = function () {
    ...
    $('*').on("tap", function (e) {
      e.preventDefault();
      this.psuedoKeys = this.psuedoKeys.concat([32, 75]);
    }.bind(this));
  ...
  GameView.prototype.pressedKeys = function () {
    ...
    var started = !this.game._diag.start;
    this.psuedoKeys = [];
    ...
    pKeys.forEach(function (pKey) {
      ...
      case 32:
        if (!started) {
          this.game._diag.start = false;
          this.game._diag.pause = false;
          break;
        }
        ship.fireBullet();
        break;
