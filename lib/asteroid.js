(function () {
  ...
  var Asteroid = Asteroids.Asteroid = function(position, game) {
    var options = {
      ...
      pos: position,
      vel: Asteroids.Util.prototype.randomVec(0.075),
      accel: [0, 0],
      game: game,
    ...
    case Asteroids.Asteroid:
      ...
      otherObj.lastCollidedObject = this;
        if (thisMass < otherMass / 4) {
          ...
          this.game.remove(this);
        } else if ((this.game.asteroids.length < (30 * this.game.MIN_FRAME_RATE / (this.game.gTime - this.game.oldTime)) && this.radius > this.MIN_RADIUS) &&
