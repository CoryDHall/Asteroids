(function () {
  ...
  var Asteroid = window.Asteroids.Asteroid = function(position, game) {
    var options = {
      ...
      pos: position,
      vel: window.Asteroids.Util.prototype.randomVec(0),
      accel: [0, 0],
      game: game,
  ...
  Asteroid.prototype.getColor = function () {
    var hue = (this.numCollisions / 10).toFixed();
    var sat = "95%";
    var light =  (10 + 90 * this.density / Asteroids.MovingObject.CRITICAL_MASS) + "%";
    // return "hsl(40, 50%, 50%)";
