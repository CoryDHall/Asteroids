(function () {
  ...
  Ship.prototype.power = function (impulse) {
    ...
    this.vel[0] += impulse[0] / (this.radius / 2 + this.vel[0]);
    this.vel[1] += impulse[1] / (this.radius / 2 + this.vel[1]);
  };
  ...
  Ship.prototype.fireBullet = function() {
    ...
    this.vel[0] -= bullet.vel[0] / this.radius;
    this.vel[1] -= bullet.vel[1] / this.radius;
  };
