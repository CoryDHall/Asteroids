  ...
  var Game = Asteroids.Game = function(dimX, dimY) {
    ...
    setInterval(function () {
      if (this.addingAsteroids) {
        ...
        newAsteroid.density = this.ship.density / (Game.NUM_ASTEROIDS * 2);
        this.add(newAsteroid);
