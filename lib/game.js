(function () {
  ...
  Game.prototype.draw = function(ctx) {
    ...
    ctx.fillStyle = "rgba(255, 255, 255, " + this._diag.erase + ")";
  ...
  Game.prototype.toggleDiag = function (code) {
    switch (code) {
      case "WEB":
        ...
        break;
      case "SMEAR":
        this._diag.erase = (1 + this._diag.erase + 0.1) % 1;
        break;
      default:
